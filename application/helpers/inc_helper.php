  ...
  function convert_level_akses($id_level_akses) {
    switch ($id_level_akses) {
      case '1': $level = "SUPER ADMIN";
        break;
      case '2': $level = "KESEHATAN I";
        break;
      case '3': $level = "KESEHATAN II";
        break;
      case '4': $level = "RUMAH SAKIT";
        break;
      case '5': $level = "LABORATORIUM";
        break;
      case '6': $level = "GUGUS TUGAS";
        break;
      case '7': $level = "PIMPINAN";
        break;
      case '8': $level = "ANALIS";
        break;
      default: $level = "";
...
/**
 * Fungsi convert pasien status
 */
 if (!function_exists('pasien_status')) {
   function pasien_status($id, $fullname = FALSE) {
     if ($fullname) {
       $arr = array(
         1 => "Orang Dalam Pemantauan",
         2 => "Pasien Dalam Pengawasan",
         3 => "Terkonfirmasi Covid-19",
         4 => "Orang Tanpa Gejala",
         5 => "Kontak Erat Kasus",
         6 => "Pelaku Perjalanan"
       );
     } else {
