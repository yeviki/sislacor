  ...
  <div class="row" id="formParent">    
    ...
    <div class="col-xs-12 col-sm-12">
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12">
          <?php echo form_open(site_url('kamar/rs-kamar/upload'), array('id' => 'formupload', 'style'=>'display:none;margin-bottom:20px;')); ?>
            <div style="display:block;background:#FFF;padding:20px;border:1px solid #CCC;box-shadow:0px 0px 10px #CCC;">
              <div class="row">
                <div class="col-xs-12 col-sm-3">
                  <div class="form-group">
...
<script type="text/javascript">
  ...
  $(document).on('click', '.download', function(e){
      url = site + '/repository/template/import_data_stok_kamar.xlsx';
  ...
  $(document).on('submit', '#formupload', function(e) {
        ...
        $.ajax({
            url: site + 'kamar/rs-kamar/upload',
            type: 'post',
            data: form_data,
