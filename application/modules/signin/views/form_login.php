...
<html lang="en">
  ...
  <body class="focusedform">
    <div class="verticalcenter" style="top:40%;left:50%;margin-top:0px;margin-left:0px;transform: translate(-50%, -50%);">
      ...
      <h1 style="text-align:center;">Tanggap <b style="color:rgb(46, 93, 172);">Covid-19</b></h1>
  				...
  				<div class="form-group">
  					<div class="col-sm-12">
  						<div class="input-group">
  							...
  							<input type="text" class="form-control" name="username" id="username" placeholder="NIP/Username" value="<?php echo set_value('username'); ?>">
