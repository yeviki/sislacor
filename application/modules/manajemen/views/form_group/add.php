  ...
  <div class="row">
    <div class="col-md-12">
      <div class="panel panel-green">
        ...
        <?php echo form_open(site_url('manajemen/group/create'), array('class' => 'form-horizontal row-border', 'role' => 'form')); ?>
        <div class="panel-body">
          <div class="form-group">
				    <label for="nama_group" class="col-sm-3 control-label">Nama Grup</label>
				    <div class="col-sm-6">
				      <input type="text" class="form-control tooltips" name="nama_group" id="nama_group" placeholder="Nama Grup" value="<?php echo set_value('nama_group'); ?>" data-trigger="hover" data-original-title="Nama grup yang akan digunakan">
          ...
          <div class="form-group">
				    ...
				    <div class="col-sm-3">
              <?php
                echo form_dropdown('level_akses', $level_akses, $this->input->post('level_akses'), 'class="select-all"');
