    ...
    <div class="col-md-12">
      <div class="panel panel-green">
        ...
        <?php echo form_open(site_url($urlform)); ?>
          ...
          <?php foreach ($data_rules as $list_module => $module): $m_class = "m_".str_replace(' ', '', strtolower($list_module));?>
          <div class="form-group well">
            ...
            <div class="row">
            <?php $i=0; foreach ($module as $list_kontrol => $kontrol): $k_class = "k_".str_replace(' ', '', strtolower($list_kontrol));?>
