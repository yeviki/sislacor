            ...
            <div class="col-xs-12 col-md-12" style="margin-top:-10px;margin-bottom:20px;">
              ...
              <div class="form-group">
                <div class="col-xs-12 col-md-2">
                  ...
                  <?php echo form_dropdown('level', $data_level, $this->input->post('level'), 'class="select-all param" id="level"');?>
                </div>
              </div>
              <div class="form-group">
                <div class="col-xs-12 col-md-3">
                  <label style="font-size:16px;"><b>Filter Daerah</b></label>
                  <?php echo form_dropdown('regency', $data_regency, $this->input->post('regency'), 'class="select-all param" id="regency"');?>
                </div>
              </div>
              <div class="form-group">
                <div class="col-xs-12 col-md-3">
                  <label style="font-size:16px;"><b>Filter Fasyankes</b></label>
                  <?php echo form_dropdown('rsud', $data_rsud, $this->input->post('rsud'), 'class="select-all param" id="rsud"');?>
                </div>
              </div>
              <div class="form-group">
                <div class="col-xs-12 col-md-2">
                  <label style="font-size:16px;"><b>Filter Blokir</b></label>
                  <?php echo form_dropdown('blokir', array(''=>'Pilih Data', 1=>'Blokir', 0=>'Tidak Blokir'), $this->input->post('blokir'), 'class="select-all param" id="blokir"');?>
                </div>
              </div>
              <div class="form-group">
                <div class="col-xs-12 col-md-2">
                  <label style="font-size:16px;"><b>Filter Status</b></label>
                  <?php echo form_dropdown('status', array(''=>'Pilih Data', 1=>'Aktif', 0=>'Tidak Aktif'), $this->input->post('status'), 'class="select-all param" id="status"');?>
                </div>
              </div>
              <?php echo form_close(); ?>
            </div>
