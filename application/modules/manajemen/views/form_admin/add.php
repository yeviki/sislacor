    ...
    <div class="col-md-12">
      <div class="panel panel-green">
        ...
        <div class="panel-body">
          ...
          <div class="form-group" id="lblRsud" style="display:none;">
            <label for="rsud" class="col-sm-3 control-label">Rumah Sakit</label>
            <div class="col-sm-5">
              <?php echo form_dropdown('rsud', $data_rsud, $this->input->post('rsud'), 'class="select-all"');?>
            </div>
          </div>
          <div class="form-group" id="lblDaerah" style="display:none;">
            <label for="regency" class="col-sm-3 control-label">Nama Daerah</label>
            <div class="col-sm-5">
              <?php echo form_dropdown('regency', $data_regency, $this->input->post('regency'), 'class="select-all"');?>
            </div>
          </div>
          <div class="form-group" id="lblLabor" style="display:none;">
            <label for="labor" class="col-sm-3 control-label">Nama Laboratorium</label>
            <div class="col-sm-7">
              <?php echo form_dropdown('labor', $data_labor, $this->input->post('labor'), 'class="select-all"');?>
            </div>
          </div>
          <div class="form-group">
