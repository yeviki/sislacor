    ...
    <div class="col-md-12">
      <div class="panel panel-midnightblue">
        ...
        <div class="panel-body">
          ...
          <div class="form-group" id="lblRsud" <?php echo (in_array(4, $groups) OR in_array(5, $groups)) ? '' : 'style="display:none;"'; ?>>
            <label for="rsud" class="col-sm-3 control-label">RS Rujukan</label>
            <div class="col-sm-5">
              <?php echo form_dropdown('rsud', $data_rsud, $data_users['id_rs'], 'class="select-all"');?>
            </div>
          </div>
          <div class="form-group" id="lblDaerah" <?php echo (in_array(3, $groups)) ? '' : 'style="display:none;"'; ?>>
            <label for="regency" class="col-sm-3 control-label">Nama Daerah</label>
            <div class="col-sm-5">
              <?php echo form_dropdown('regency', $data_regency, $data_users['id_regency'], 'class="select-all"');?>
            </div>
          </div>
          <div class="form-group" id="lblLabor" <?php echo (in_array(6, $groups)) ? '' : 'style="display:none;"'; ?>>
            <label for="labor" class="col-sm-3 control-label">Nama Laboratorium</label>
            <div class="col-sm-7">
              <?php echo form_dropdown('labor', $data_labor, $data_users['id_labor'], 'class="select-all"');?>
            </div>
          </div>
          <div class="form-group">
