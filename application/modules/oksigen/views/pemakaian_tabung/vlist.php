  ...
  <div class="row" id="formParent">    
    <div class="col-xs-12 col-sm-12">
      <div class="btn-toolbar" style="margin-bottom: 15px">
        <a type="button" href="<?php echo site_url('oksigen/pemakaian-tabung'); ?>" class="btn btn-inverse" name="button" style="padding:12px 16px;"><b><i class="fa fa-table"></i></b></a>
  ...
  <div class="modal-dialog modal-lg" id="frmEntry">
    <div class="modal-content">
      <div class="modal-header" style="padding:10px 15px 10px 15px;">
        ...
        <h4 class="modal-title"><b>FORM ENTRI PEMAKAIAN OKSIGEN</b></h4>
      </div>
      <?php echo form_open(site_url('oksigen/pemakaian-tabung/create'), array('id' => 'formEntry')); ?>
...
<script type="text/javascript">
  ...
  function getDataList() {
    $('#tblVaksin').dataTable({
      ...
      "ordering": false,
      "ajax": {
        "url": site + "oksigen/pemakaian-tabung/listview",
        "type": "POST",
        "data": {
      ...
      buttons: {
        ...
        "main" : {
          ...
          callback:function(response){
            if (response) {
              $.ajax({
                url: site + 'oksigen/pemakaian-tabung/delete',
                type: "POST",
                data: postData,
                dataType: "json",
              }).done(function(data) {
