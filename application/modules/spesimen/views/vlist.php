                  ...
                  <div class="form-group">
                    ...
                    <?php
                      if($this->app_loader->is_lab())
                        echo form_dropdown('laboratorium', array(''=>'Pilih Laboratorium', $this->app_loader->current_labor()=>laboratorium($this->app_loader->current_labor())), $this->app_loader->current_labor(), 'class="select-all param"');
                      else
                        echo form_dropdown('laboratorium', $data_labor, $this->input->post('laboratorium', TRUE), 'class="select-all param"');
                    ?>
                  </div>
                </div>
              </div>
...
<div class="modal fade bs-example-modal-lg in" id="modalSpecimenForm" tabindex="-1" role="dialog" aria-labelledby="modalSpecimenLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" id="frmSpecimen">
    <div class="modal-content">
      ...
      <?php echo form_open(site_url('spesimen/pengujian/update'), array('id' => 'formSpecimen')); ?>
      <div class="modal-body" style="padding:0px;">
        <div style="padding:10px 10px 0px 10px;margin-bottom:-10px;" id="errUpdate"></div>
        <table cellspacing="0" cellpadding="0" class="table" width="100%">
          <tbody>
            ...
            <tr style="background-color:#D1FFE3">
              <td>
                <div class="row" style="padding-left:3px;padding-right:3px;">
                  <?php echo form_hidden('swabId', ''); echo form_hidden('tokenId', ''); ?>
                  <div class="col-xs-12 col-sm-2">
                    <div class="form-group required">
                      <label for="hasil_lab" class="control-label" style="margin-bottom:0px;"><b>Hasil Lab <font color="red">*</font></b></label>
                      <?php foreach (array('P'=>'POSITIF', 'N'=>'NEGATIF', 'I'=>'INCONCLUSIVE') as $key => $hl): ?>
                        <div class="radio">
                          <label>
                            <input type="radio" name="hasil_lab" id="<?php echo 'hasil_lab_'.$key ?>" value="<?php echo $key; ?>" <?php echo set_radio('hasil_lab', ''); ?>><b><?php echo $hl; ?></b>
                          </label>
                        </div>
                      <?php endforeach; ?>
                      <div class="help-block"></div>
                  ...
                  <div class="col-xs-12 col-sm-6">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" placeholder="Keterangan" name="keterangan" id="keterangan" rows="5"><?php echo $this->input->post('keterangan', TRUE); ?></textarea>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-4">
                    <div class="form-group required">
                      ...
                      <div class="input-group date datemonth">
                        <input type="text" class="form-control mask" name="tgl_kirim" id="tgl_kirim" placeholder="dd/mm/yyyy" data-inputmask="'alias': 'date'" value="<?php echo $this->input->post('tgl_kirim', TRUE); ?>" disabled>
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      </div>
                      <div class="help-block"></div>
                    </div>
                    <div class="form-group required" style="margin-top:30px;">
                      <label for="tgl_keluar" class="control-label"><b>Tgl. Spesimen Keluar <font color="red">*</font></b></label>
                      <div class="input-group date datemonth">
                        <input type="text" class="form-control mask" name="tgl_keluar" id="tgl_keluar" placeholder="dd/mm/yyyy" data-inputmask="'alias': 'date'" value="<?php echo $this->input->post('tgl_keluar', TRUE); ?>">
                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      </div>
                      <div class="help-block"></div>
                    </div>
              ...
              <td>
                <div class="row" style="padding-left:3px;padding-right:3px;">
                  ...
                  <div class="col-xs-12 col-xs-4">
                    <div class="form-group required">
                      ...
                      <input type="text" class="form-control toUpperCase" name="namalkp" id="namalkp" placeholder="Nama Pasien" value="<?php echo $this->input->post('namalkp', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                  <div class="col-xs-12 col-xs-3">
                    <div class="form-group required">
                      ...
                      <input type="text" class="form-control" name="nik" id="nik" placeholder="NIK" value="<?php echo $this->input->post('nik', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                  <div class="col-xs-12 col-xs-2">
                    <div class="form-group required">
                      ...
                      <input type="text" class="form-control" name="umur" id="umur" placeholder="Umur (th)" value="<?php echo $this->input->post('umur', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                  <div class="col-xs-12 col-xs-3">
                    <div class="form-group required">
                      ...
                      <input type="text" class="form-control toUpperCase" name="gender" id="gender" placeholder="Jenis Kelamin" value="<?php echo $this->input->post('gender', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                </div>
                <div class="row" style="padding-left:3px;padding-right:3px;">
                  <div class="col-xs-12 col-sm-3">
                    <div class="form-group required">
                      <label for="province" class="control-label"><b>Provinsi</b></label>
                      <input type="text" class="form-control toUpperCase" name="province" placeholder="Provinsi" value="<?php echo $this->input->post('province', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-3">
                    <div class="form-group required">
                      <label for="regency" class="control-label"><b>Kab/Kota</b></label>
                      <input type="text" class="form-control toUpperCase" name="regency" placeholder="Kab/Kota" value="<?php echo $this->input->post('regency', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-3">
                    <div class="form-group required">
                      <label for="district" class="control-label"><b>Kecamatan</b></label>
                      <input type="text" class="form-control toUpperCase" name="district" placeholder="Kecamatan" value="<?php echo $this->input->post('district', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-3">
                    <div class="form-group required">
                      <label for="village" class="control-label"><b>Kelurahan</b></label>
                      <input type="text" class="form-control toUpperCase" name="village" placeholder="Kelurahan" value="<?php echo $this->input->post('village', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                </div>
                <div class="row" style="padding-left:3px;padding-right:3px;">
                  <div class="col-xs-12 col-sm-5">
                    <div class="form-group required">
                      ...
                      <input type="text" class="form-control toUpperCase" name="hospital" id="hospital" placeholder="Rumah Sakit" value="<?php echo $this->input->post('hospital', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                  <div class="col-xs-12 col-sm-7">
                    <div class="form-group required">
                      ...
                      <input type="text" class="form-control toUpperCase" name="labor" id="labor" placeholder="Laboratorium" value="<?php echo $this->input->post('labor', TRUE); ?>" disabled>
                      <div class="help-block"></div>
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
  ...
  $(document).on('click', '.btnAdd', function(e) {
    ...
    if(flag==1) {
      $('.modal-footer').find('.btnClose').html('<i class="fa fa-times"></i> CANCEL');
      $('.modal-footer').find('.btnClose').after('<button type="submit" class="btn btn-primary" name="save" id="save" style="padding:12px 16px;"><i class="fa fa-check"></i> SUBMIT</button>');
    } else {
      $('.modal-footer').find('.btnClose').html('<i class="fa fa-times"></i> CLOSE');
      $('.modal-footer').find('#save').remove();
    }
      ...
      success: function(data) {
        ...
        if(data.status == 1) {
          if(data.message.status == 2) {
            $('input[name="hasil_lab"]').attr('disabled', true);
            $('input[name="tgl_keluar"]').attr('disabled', true);
            $('textarea[name="keterangan"]').attr('disabled', true);
          } else {
            $('input[name="hasil_lab"]').removeAttr('disabled');
            $('input[name="tgl_keluar"]').removeAttr('disabled');
  ...
  $('#formSpecimen').submit(function(e) {
    e.preventDefault();
    ...
    bootbox.dialog({
      title: "Konfirmasi",
      message: "Apakah anda akan memperharui hasil pemeriksaan spesimen ini ?",
      buttons: {
        "cancel" : {
              ...
              $.ajax({
                ...
                if(data.status == 0) {
                  ...
                  $.each(data.message, function(key,value){
                    if(key != 'isi')
                      $('input[name="'+key+'"]').closest('div.required').addClass('has-error').find('div.help-block').text(value);
                    else {
                      $('#pesanErr').html('<strong>Peringatan!</strong> ' +value);
                    }
                  });
                  $('#modalSpecimenForm').animate({
